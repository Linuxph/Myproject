      ...
      >
        ...
        <div className="w-full mt-8">
          <div className="mx-auto max-w-xs sm:max-w-md md:max-w-lg flex flex-col gap-4">
            ...
            <form  className=" flex flex-col gap-3" action="http//localhost:3000/api/v1/signUp" onSubmit={handleSubmit} method="post">
                    <input
                  ...
                  <input
                    ...
                    />
                  <button type="submit" className="mt-5 tracking-wide font-semibold bg-[#0F67B1] text-gray-100 w-full py-4 rounded-lg hover:bg-[#0F67B1]/90 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                    <svg
          ...
          <div className={` text-red-500 text-center mt-2 ${errorDiv ? 'block': 'hidden'} rounded-3xl`}> {errormessage} </div>
        </div>
      </div>
      {/* <div className="p-1"><Link to='/adminlogin'>Are you looking for the admin login?</Link></div> */}
    </div>
  );
};
