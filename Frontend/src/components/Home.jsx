...
const Home = () => {
  ...
  return (
    ...
    >
    {signIn ? (
      <div className=" w-[100%] bg-[#36C2CE]  p-5 flex flex-wrap justify-center gap-8 xl:justify-normal p-5">
            ...
            <div>
              ...
              >
                ...
                <div className="h-[100%]  ">
                  ...
                  <hr />
                  <motion.button
                    onClick={() => { localStorage.setItem("movieId",selectedId); navigate('/booking')}}
